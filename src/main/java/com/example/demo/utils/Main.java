...
public class Main {
    ...
    public static List<Integer> main(Integer uid) throws IOException, TasteException {
        ...
        String file = "/Users/mac/Documents/GraduationProject/movie/data.csv";   //数据集，其中第一列表示用户id；第二列表示商品id；第三列表示评分，评分是5分制
...
//        {
//            long uid = iter.nextLong();
        List<RecommendedItem> list = r.recommend(1, RECOMMENDER_NUM);  //获取推荐结果
